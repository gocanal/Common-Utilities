...
public enum MMCQ
{
    ...
    public CMap quantize(int[][] pixels, int maxcolors)
    {
        // short-circuit
    ...
    private final Comparator<VBox> COMPARATOR_COUNT = new Comparator<VBox>()
    {
        @Override
    ...
    private final Comparator<VBox> COMPARATOR_PRODUCT = new Comparator<VBox>()
    {
        @Override
        public int compare(VBox a, VBox b)
        {
