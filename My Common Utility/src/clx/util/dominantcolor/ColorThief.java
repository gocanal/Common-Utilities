...
public enum ColorThief {
	 ...
	 */
	public int[] getColor(BufferedImage sourceImage)
	{
	 ...
	 */
	public int[][] getPalette(BufferedImage sourceImage, int colorCount)
	{
	 ...
	 */
	public CMap getColorMap(BufferedImage sourceImage, int colorCount)
	{
		return getColorMap(
				sourceImage,
				colorCount,
			...
			boolean ignoreWhite)
	{
		...
		// cut algorithm
		CMap cmap = MMCQ.INSTANCE.quantize(pixelArray, colorCount);
		return cmap;
	}
